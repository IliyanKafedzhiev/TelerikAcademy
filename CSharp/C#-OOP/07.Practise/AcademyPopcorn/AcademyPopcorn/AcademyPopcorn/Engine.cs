...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        int treadSleepInMiliSeconds;

        public Engine(IRenderer renderer, IUserInterface userInterface, int treadSleepInMiliSeconds = 250)
        {
            this.treadSleepInMiliSeconds = treadSleepInMiliSeconds;
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(this.treadSleepInMiliSeconds);
